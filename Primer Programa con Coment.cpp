...
#include <iostream> //Inclusion de la librearia de entrada y salida. 
...
{ //Inicio
	...
	numero = 5 + 5; //Asignacion de la suma de 5+5 a la varaible numero.
	/*Impresion del resultado de la variable numero
	Y adicion al final del salto de linea. 
	*/
